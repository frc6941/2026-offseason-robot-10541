...
public class SwerveDriveToPose extends Command {
    private static final String kTag = "Commands/DriveToPose";
    ...
    public boolean isFinished() {
        ...
        boolean translationOnTarget =
                epsilonEquals(
                        TRT.getTranslation().toTranslation2d(), new Translation2d(), tolTransM);
        boolean rotationOnTarget =
                epsilonEquals(TRT.getRotation().toRotation2d().getDegrees(), 0.0, tolRotDeg);
