 ...
 * control logic.
 *
 * <p>The logged value is a {@code Pose3d[]} under {@code Mechanism3d/Measured}; AdvantageScope binds
 * component <i>i</i> of its robot config to index <i>i</i> of this array. The order is fixed below.
 * Each pose is robot-relative: the component's joint origin (a fixed mount {@link Translation3d}
 * from robot center) plus the live joint rotation.
 *
 ...
 * which axis (and sign) each joint rotates about. WPILib robot frame: +X forward, +Y left, +Z up;
 * a hood/intake that pitches rotates about Y.
 */
public class RobotMechanism3d extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // TODO: verify each joint's rotation axis and sign against CAD (both assumed pitch about +Y)
